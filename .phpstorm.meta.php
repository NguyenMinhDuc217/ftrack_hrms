...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\hrms\\public\\storage','logging.default','logging.deprecations.channel',
...
'session.same_site','session.partitioned','translation-loader.translation_loaders','translation-loader.model','translation-loader.translation_manager',
...
'debugbar.queries.explain','client.home','language.switch','login','register','google.redirect','google.callback',
'logout','client.dashboard','client.profile','profile','profile.save.summary',
'profile.save.experience','profile.delete.experience','profile.get.education','profile.save.education','profile.delete.education',
'profile.save.skill','profile.delete.skill','profile.save.skill-group','profile.delete.skill-group','profile.save.language',
'profile.delete.language','profile.save.project','profile.delete.project','profile.save.certificate','profile.delete.certificate',
'profile.save.award','profile.delete.award','admin.dashboard','admin.users','admin.users.create',
'admin.users.store','admin.users.show','admin.users.update','admin.users.delete','admin.users.changeDepartment',
'admin.departments','admin.jobs.index','admin.jobs.create','admin.jobs.store','admin.jobs.show',
'admin.jobs.update','admin.jobs.delete','admin.blog.index','admin.blog.create','admin.blog.store',
'admin.blog.show','admin.blog.update','admin.blogs.delete','admin.role.index','admin.role.create',
'admin.role.store','admin.role.edit','admin.role.update','admin.role.delete','admin.role.permissions.update',
'admin.permission.index','admin.menu.index','storage.local',);
        registerArgumentsSet('views', 
'admin.blog.add','admin.blog.edit','admin.blog.index','admin.dashboard','admin.department.index',
'admin.job.add','admin.job.edit','admin.job.index','admin.menu.index','admin.organization.index',
'admin.partials._footer','admin.partials._head','admin.partials._header','admin.partials._preloader','admin.partials._scripts',
'admin.partials._sidebar','admin.permission.index','admin.role.form','admin.role.index','admin.user.add',
'admin.user.edit','admin.user.index','auth.login','auth.register','client.dashboard',
'client.home.banner','client.home.blog','client.home.index','client.home.job-list','client.home.register-cv',
'client.home.statistical','client.index','client.partials._scripts','client.partials.footer','client.partials.header',
'client.profile','common.css.custom','components.admin.permission-assign','components.admin.sidebar','cv.modal.award',
...
'cv.partials.experience','cv.partials.language','cv.partials.project','cv.partials.skill','cv.partials.summary',
'cv.profile.index','index','layouts.admin','layouts.client','pagination::bootstrap-4',
...
'auth.failed','auth.password','auth.throttle','default.apples','default.vi',
'default.en','default.btn_submit','default.btn_reset','default.button_confirm','default.button_cancel',
...
'default.button_filter','default.button_reset','default.button_add','default.txt_search','default.txt_users',
'default.txt_home','default.showing','default.to','default.of','default.results',
'default.maxlength_set_to_characters','default.maxlength_set_to_numbers','default.number','default.enter_a_date_after','default.enter_a_date_before',
'default.enter_a','default.txt_home_search_placeholder','default.txt_location','default.txt_active','default.txt_inactive',
'job.txt_add_job','job.txt_edit_job','job.txt_title','job.txt_province','job.txt_headcount',
'job.txt_description','job.txt_requirements','job.txt_min_salary','job.txt_max_salary','job.txt_currency',
'job.title_required','job.title_string','job.title_max','job.department_id_exists','job.province_code_required',
'job.province_code_string','job.province_code_max','job.province_code_in','job.employment_type_string','job.employment_type_enum',
'job.headcount_integer','job.description_md_string','job.requirements_md_string','job.min_salary_decimal','job.max_salary_decimal',
'job.currency_string','job.currency_max','job.status_boolean','pagination.previous','pagination.next',
'passwords.reset','passwords.sent','passwords.throttled','passwords.token','passwords.user',
'role.page_title_create','role.heading_title_create','role.page_title_edit','role.heading_title_edit','role.create',
'role.edit','role.not_found_id','role.not_found_ajax','role.deleted_success','role.permission_assignment',
'role.save_permissions','role.permissions_updated_success','role.permissions_update_failed','role.super_admin','role.admin',
'role.hr_manager','user.username_required','user.username_string','user.username_max','user.email_required',
'user.email_email','user.email_unique','user.phone_number_numeric','user.phone_number_digits','user.phone_number_unique',
'user.first_name_string','user.first_name_max','user.last_name_string','user.last_name_max','user.gender_required',
'user.gender_string','user.gender_max','user.gender_enum','user.date_of_birth_date','user.date_of_birth_before',
'user.hire_date_date','user.hire_date_before_or_equal','user.hire_date_after','user.department_id_exists','user.manager_id_exists',
'user.document_id_exists','user.document_id_integer','user.employment_type_string','user.employment_type_enum','user.applicant_boolean',
'user.status_string','user.status_enum','user.txt_add_user','user.txt_edit_user','user.txt_user_id',
'user.txt_username','user.txt_firstname','user.txt_lastname','user.txt_email','user.txt_phone_number',
'user.txt_gender','user.txt_date_of_birth','user.txt_hire_date','user.txt_department','user.txt_manager',
'user.txt_document','user.txt_employment_type','user.txt_applicant','user.txt_status','user.txt_actions',
'user.txt_active','user.txt_expired','user.txt_unverified','user.txt_fulltime','user.txt_parttime',
'user.txt_contract','user.txt_intern','user.txt_male','user.txt_female','user.txt_other',
...
'job.min_salary_integer','job.max_salary_integer','validation.attributes.role','validation.attributes.second','validation.attributes.sex',
'validation.attributes.shipment','validation.attributes.short_text','validation.attributes.size','validation.attributes.state','validation.attributes.street',
...
'validation.attributes.value','validation.attributes.year','validation.attributes.full_name','validation.attributes.start_date','validation.attributes.end_date',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET',
'GOOGLE_REDIRECT_URL','APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL',
'LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DEBUGBAR_EDITOR','DB_CONNECTION',
