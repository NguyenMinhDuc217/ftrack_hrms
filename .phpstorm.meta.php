...
'admin.role.index','admin.permission.index','admin.menu.index','storage.local',);
...
'admin.role.index','admin.user.edit','admin.user.index','auth.login','auth.register',
'client.dashboard','client.index','client.partials.footer','client.partials.header','client.profile',
'components.admin.sidebar','index','layouts.admin','layouts.client','pagination::bootstrap-4',
