    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'translation.loader' => \App\Services\Translation\TranslationLoaderManager::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\ftrack_hrms\public\storage' => 'string',
...
'auth.passwords.users.throttle','auth.password_timeout','auth.socialite.drivers','cache.default','cache.stores.array.driver',
...
'filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\ftrack_hrms\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.secure','session.http_only','session.same_site','session.partitioned','translation-loader.translation_loaders',
'translation-loader.model','translation-loader.translation_manager','laravel-pdf.browsershot.node_binary','laravel-pdf.browsershot.npm_binary','laravel-pdf.browsershot.include_path',
...
'laravel-pdf.browsershot.no_sandbox','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'role_or_permission','check.permission',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.clockwork','debugbar.assets.css','debugbar.assets.js','debugbar.cache.delete',
'debugbar.queries.explain','client.home','client.job.detail','client.org.detail',
'client.current.location','language.switch','login','register','google.redirect','google.callback','logout','client.dashboard','client.profile','profile',
'profile.save.summary','profile.save.experience','profile.delete.experience','profile.get.education','profile.save.education',
'profile.delete.education','profile.save.skill','profile.delete.skill','profile.save.skill-group','profile.delete.skill-group',
'profile.save.language','profile.delete.language','profile.save.project','profile.delete.project','profile.save.certificate',
'profile.delete.certificate','profile.save.award','profile.delete.award','cv.preview-pdf','cv.manage',
'cv.upload','cv.delete','clear.create.cv.flag','apply.job','admin.dashboard',
'admin.users','admin.users.create','admin.users.store','admin.users.show','admin.users.update',
'admin.users.delete','admin.users.changeDepartment','admin.departments','admin.jobs.index','admin.jobs.create',
'admin.jobs.store','admin.jobs.show','admin.jobs.update','admin.jobs.delete','admin.blogs.index',
'admin.blogs.create','admin.blogs.store','admin.blogs.show','admin.blogs.update','admin.blogs.delete',
'admin.role.index','admin.role.create','admin.role.store','admin.role.edit','admin.role.update',
'admin.role.delete','admin.role.permissions.update','admin.permission.index','admin.menu.index','admin.files.upload',
'admin.files.store','admin.orgs.index','admin.orgs.create','admin.orgs.store','admin.orgs.show',
'admin.orgs.update','admin.orgs.delete','admin.upload.editor.image','admin.applications.index','admin.applications.show',
'admin.files.upload-editor-image','storage.local',);
        registerArgumentsSet('views', 
'admin.application.index','admin.application.index-area','admin.application.show','admin.blog.add','admin.blog.edit',
'admin.blog.index','admin.dashboard','admin.department.index','admin.files.upload','admin.job.add',
'admin.job.edit','admin.job.form','admin.job.index','admin.menu.index','admin.organization.add',
'admin.organization.edit','admin.organization.index','admin.partials._footer','admin.partials._head','admin.partials._header',
'admin.partials._preloader','admin.partials._scripts','admin.partials._sidebar','admin.permission.index','admin.role.form',
'admin.role.index','admin.user.add','admin.user.edit','admin.user.index','auth.login',
'auth.register','client.cv.cv1','client.dashboard','client.home.banner','client.home.blog',
'client.home.index','client.home.job-list','client.home.register-cv','client.home.statistical','client.index',
'client.job.detail','client.org.detail','client.partials._scripts','client.partials.footer','client.partials.header',
'client.profile','common.css.custom','components.admin.permission-assign','components.admin.sidebar','components.client.create_cv',
'components.client.elements.button','components.client.filter','components.client.login','cv.manage','cv.modal.award',
'cv.modal.certificate','cv.modal.education','cv.modal.experience','cv.modal.language','cv.modal.project',
'cv.modal.skill','cv.modal.summary','cv.partials.award','cv.partials.certificate','cv.partials.education',
'cv.partials.experience','cv.partials.language','cv.partials.profile','cv.partials.project','cv.partials.skill',
'cv.partials.summary','cv.profile.index','index','layouts.admin','layouts.client',
...
'vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.custom','vendor.pagination.default','vendor.pagination.semantic-ui',
...
'application.txt_info_user','application.txt_info_job','auth.failed','auth.password','auth.throttle',
'auth.txt_register_for_an_acc','auth.txt_register','auth.txt_login','auth.txt_login_here','auth.txt_already_account',
'auth.txt_login_to_your_account','auth.txt_login_with_google','auth.txt_remember_me','auth.txt_dont_have_account','auth.txt_register_here',
'cv.profile','cv.summary','cv.education','cv.work_experience','cv.skills',
'cv.languages','cv.projects','cv.certificates','cv.certificate','cv.awards',
'cv.award','cv.project','cv.language','cv.core_skills','cv.soft_skills',
'cv.contact_info','cv.full_name','cv.gender','cv.professional_title','cv.date_of_birth',
'cv.phone_number','cv.province','cv.address','cv.professional_summary','cv.avatar',
'cv.start_date','cv.end_date','cv.is_current','cv.current_studying','cv.current_working',
'cv.current_project','cv.description','cv.company_name','cv.position','cv.school',
'cv.degree','cv.major','cv.level','cv.proficiency','cv.organization',
'cv.issue_date','cv.expiration_date','cv.year','cv.url','cv.project_name',
'cv.certificate_name','cv.award_name','cv.manage_skills','cv.group_name','cv.add_skills',
'cv.skills_list','cv.native','cv.fluent','cv.intermediate','cv.basic',
'cv.exp','cv.year_1','cv.year_2','cv.year_3','cv.year_4',
'cv.year_5_plus','cv.year_10_plus','cv.edit','cv.delete','cv.add',
'cv.save','cv.save_changes','cv.save_group','cv.close','cv.cancel',
'cv.confirm','cv.select','cv.select_province','cv.placeholder_title','cv.placeholder_address',
'cv.placeholder_summary','cv.placeholder_skill','cv.placeholder_language','cv.user_name_default','cv.title_default',
'cv.email_default','cv.phone_default','cv.dob_default','cv.gender_default','cv.address_default',
'cv.no_education','cv.no_experience','cv.no_skills','cv.no_projects','cv.present',
'cv.na','cv.issued','cv.years_count','cv.summary_default','cv.confirm_delete_title',
'cv.confirm_delete_text','cv.confirm_delete_yes','cv.group_name_required','cv.error_saving_skills','cv.confirm_delete_group_title',
'cv.confirm_delete_group_text','cv.delete_error','cv.save_error','cv.validation_required','cv.manage_cvs',
'cv.your_cv','cv.uploaded','cv.delete_cv','cv.confirm_delete_cv','cv.no_cv_attached',
'cv.upload_cv','cv.upload_file_rules','cv.upload_success','cv.delete_success','cv.user_cv_title',
'cv.cv_name','cv.placeholder_cv_name','cv.cv_file_required','cv.cv_file_mimes','cv.cv_file_max',
'cv.cv_name_required','cv.cv_name_max','cv.txt_welcome','cv.txt_you_not_cv','cv.txt_create_cv_des',
'cv.txt_support_type_file','cv.txt_skip_create_cv','cv.no_cv_uploaded_yet','cv.upload_cv_suggestion','default.apples',
'default.vi','default.en','default.txt_home','default.txt_login','default.txt_register',
'default.txt_welcome','default.txt_profile','default.txt_cv','default.txt_logout','default.btn_submit',
'default.btn_reset','default.btn_back','default.btn_close','default.button_confirm','default.button_cancel',
'default.delete_confirm_title','default.delete_confirm_text','default.delete_success_text','default.delete_error_text','default.toggle_all',
'default.button_filter','default.button_reset','default.button_add','default.txt_search','default.txt_clear',
'default.txt_get_current_location','default.txt_users','default.txt_apply','default.showing','default.to',
'default.of','default.results','default.maxlength_set_to_characters','default.maxlength_set_to_numbers','default.number',
'default.text','default.enter_a_date_after','default.enter_a_date_before','default.enter_a','default.txt_home_search_placeholder',
'default.txt_location','default.txt_active','default.txt_inactive','default.txt_job','default.txt_newest',
'default.txt_user','default.txt_everyday','default.txt_partner','default.txt_tepresentative','default.txt_personnel_growth',
'default.txt_fastest_adaptation','default.txt_feild_staff_nationwide','default.txt_outlets_covered','default.txt_merchandising_visits_year','default.txt_audit_visits_year',
'default.txt_register_cv_title_1','default.txt_register_cv_title_2','default.txt_register_cv_des','default.txt_register_cv_btn','default.txt_company',
'default.txt_about_us','default.txt_service','default.txt_services','default.txt_case_studies','default.txt_contact',
'default.txt_merchandising','default.txt_auditing','default.txt_posm_deloyment','default.txt_store_activation','default.txt_mystery_shopping',
'default.txt_kpi_tracking','default.txt_sales_force','default.txt_get_in_touch','default.txt_company_address','default.error_location_not_found',
'job.txt_add_job','job.txt_edit_job','job.txt_title','job.txt_province','job.txt_can_choose_multiple',
'job.txt_headcount','job.txt_description','job.txt_requirements','job.txt_min_salary','job.txt_max_salary',
'job.txt_currency','job.txt_start_date','job.txt_end_date','job.txt_image','job.txt_tag',
'job.txt_tag_example','job.title_required','job.title_string','job.title_max','job.profession_id_exists',
'job.profession_id_required','job.profession_id_max','job.province_code_required','job.province_code_string','job.province_code_max',
'job.province_code_in','job.employment_type_string','job.employment_type_enum','job.tag_ids_required','job.tag_ids_max',
'job.tag_ids_array','job.headcount_integer','job.description_md_string','job.requirements_md_string','job.min_salary_required',
'job.min_salary_decimal','job.min_salary_lte','job.max_salary_required','job.max_salary_decimal','job.max_salary_gte',
'job.currency_required','job.currency_string','job.currency_max','job.start_date_required','job.start_date_date',
'job.start_date_date_format','job.end_date_required','job.end_date_date','job.end_date_date_format','job.end_date_after_or_equal',
'job.images_array','job.imagesmax','job.images_image','job.images_mimes','job.images_all_max',
'job.org_id_required','job.org_id_exists','job.status_boolean','job.job_not_exists','job.province_not_exists',
'job.application_area_not_exists','job.cv_not_exists','job.apply_success','job.apply_failed','job.txt_filter_by',
'job.txt_category','job.txt_salary','job.txt_income','job.txt_location','job.txt_experience',
'job.txt_no_experience','job.txt_year','job.txt_apply_deadline','job.txt_left','job.txt_days',
'job.txt_apply_now','job.txt_otherwhere','job.txt_and','job.txt_detail','job.txt_company_des',
'job.txt_company_address','job.txt_scale','job.txt_employees','job.txt_business_field','job.txt_see_company_page',
'job.txt_recruitment_info','job.txt_number_of_recruitment','job.txt_form_of_work','job.txt_area_recruitment','job.txt_salary_rank',
'job.txt_apply_cv_required','job.txt_apply_application_area_required','job.txt_apply','job.txt_choose_cv_apply','job.txt_choose_cv_available',
'job.txt_choose_cv','job.txt_create_new_cv','job.txt_cv_name','job.txt_upload_cv','job.txt_update_cv_available',
'job.txt_create_cv','job.txt_sales_staff','job.txt_display_staff','job.txt_marketing_staff','org.txt_org',
'org.txt_add_org','org.txt_edit_org','org.txt_logo','org.txt_name','org.txt_slug',
'org.txt_description','org.txt_link','org.txt_official_website','org.txt_email','org.txt_phone_number',
'org.txt_address','org.txt_workforce_size','org.txt_people','org.txt_latitude','org.txt_longitude',
'org.txt_name_required','org.txt_name_string','org.txt_name_max','org.txt_email_required','org.txt_email_email',
'org.txt_email_unique','org.txt_image_required','org.txt_image_image','org.txt_image_mimes','org.txt_image_max',
'org.txt_phone_number_required','org.txt_phone_number_numeric','org.txt_phone_number_digits_between','org.txt_phone_number_unique','org.txt_slug_required',
'org.txt_slug_string','org.txt_slug_max','org.txt_description_required','org.txt_description_string','org.txt_address_required',
'org.txt_address_string','org.txt_address_max','org.txt_link_required','org.txt_link_url','org.txt_business_field_required',
'org.txt_business_field_string','org.txt_business_field_max','org.txt_workforce_size_required','org.txt_workforce_size_string','org.txt_workforce_size_max',
'org.txt_latitude_numeric','org.txt_latitude_between','org.txt_longitude_numeric','org.txt_longitude_between','org.txt_status_required',
'org.txt_status_string','org.txt_status_in','org.txt_success_add','org.txt_success_update','org.txt_success_delete',
'org.txt_failed_add','org.txt_failed_update','org.txt_failed_delete','org.txt_failed_image','org.txt_active_jobs',
'org.txt_openings','org.txt_job_openings','org.txt_load_more_jobs','org.txt_collapse','org.txt_view_on_google_maps',
'pagination.previous','pagination.next','passwords.reset','passwords.sent','passwords.throttled',
'passwords.token','passwords.user','role.page_title_create','role.heading_title_create','role.page_title_edit',
'role.heading_title_edit','role.create','role.edit','role.not_found_id','role.not_found_ajax',
'role.deleted_success','role.permission_assignment','role.save_permissions','role.permissions_updated_success','role.permissions_update_failed',
'role.super_admin','role.admin','role.hr_manager','user.username_required','user.username_string',
'user.username_max','user.email_required','user.email_email','user.email_unique','user.phone_number_required',
'user.phone_number_numeric','user.phone_number_digits','user.phone_number_unique','user.first_name_string','user.first_name_max',
'user.last_name_string','user.last_name_max','user.gender_required','user.gender_string','user.gender_max',
'user.gender_enum','user.date_of_birth_date','user.date_of_birth_before','user.hire_date_date','user.hire_date_before_or_equal',
'user.hire_date_after','user.department_id_exists','user.manager_id_exists','user.document_id_exists','user.document_id_integer',
'user.employment_type_string','user.employment_type_enum','user.tag_id_required','user.tag_id_max','user.tag_id_array',
'user.applicant_boolean','user.status_string','user.status_enum','user.txt_add_user','user.txt_edit_user',
'user.txt_user_id','user.txt_username','user.txt_firstname','user.txt_lastname','user.txt_email',
'user.txt_phone_number','user.txt_gender','user.txt_date_of_birth','user.txt_hire_date','user.txt_profession',
'user.txt_manager','user.txt_document','user.txt_employment_type','user.txt_applicant','user.txt_status',
'user.txt_actions','user.txt_active','user.txt_expired','user.txt_unverified','user.txt_fulltime',
'user.txt_parttime','user.txt_contract','user.txt_intern','user.txt_male','user.txt_female',
'user.txt_other','user.txt_password','user.txt_confirm_password','user.txt_user_not_exists','user.txt_phone_number_not_exists',
'user.txt_please_fill_phone_number','validation.accepted','validation.accepted_if','validation.active_url','validation.after',
...
'validation.custom.attribute-name.rule-name','job.min_salary_integer','job.max_salary_integer','job.images.max','validation.attributes.role',
...
'validation.attributes.state','validation.attributes.street','validation.attributes.title','validation.attributes.type','validation.attributes.updated_at',
'validation.attributes.user','validation.attributes.username','validation.attributes.value','validation.attributes.year','validation.attributes.full_name',
'validation.attributes.start_date','validation.attributes.end_date',);
...
'DEBUGBAR_EDITOR','DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE',
...
'AWS_ENDPOINT','DEFAULT_UPLOAD_PATH','VITE_APP_NAME','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET',
'GOOGLE_REDIRECT_URL','GOOGLE_MAPS_API_KEY',);
