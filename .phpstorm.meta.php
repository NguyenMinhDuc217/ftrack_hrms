...
'translation-loader.translation_manager','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'debugbar.queries.explain','client.home','language.switch','login','register','logout','client.dashboard',
'client.profile','admin.dashboard','admin.users','admin.users.show','admin.users.update',
'admin.users.changeDepartment','admin.departments','admin.role.index','admin.role.create','admin.role.store',
'admin.role.edit','admin.role.update','admin.role.delete','admin.role.permissions.update','admin.permission.index',
'admin.menu.index','storage.local',);
...
'client.profile','components.admin.permission-assign','components.admin.sidebar','index','layouts.admin',
'layouts.client','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'default.delete_confirm_title','default.delete_confirm_text','default.delete_success_text','default.delete_error_text','pagination.previous',
'pagination.next','passwords.reset','passwords.sent','passwords.throttled','passwords.token',
'passwords.user','role.page_title_create','role.heading_title_create','role.page_title_edit','role.heading_title_edit',
'role.create','role.edit','role.not_found_id','role.not_found_ajax','role.deleted_success',
'role.permission_assignment','role.save_permissions','role.permissions_updated_success','role.permissions_update_failed','validation.accepted',
