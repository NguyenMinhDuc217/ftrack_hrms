    ...
    <div class="container mx-auto px-0">
        ...
        <div class="bg-[#f0f0f0] p-8 md:p-12 shadow-sm border border-green-100 flex flex-col md:flex-row items-center relative overflow-hidden">
            ...
            <div class="w-full md:w-1/2 z-10 mb-8 md:mb-0">
                ...
                <x-client.elements.button type="button" id="register_cv" class="font-bold p-2 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 group alumni-font">
            ...
            <div class="w-full md:w-1/2 flex justify-center z-10">
                <div class="relative w-full max-w-md">
                    <div class="bg-blue-200 rounded-2xl p-4 transform rotate-3 hover:rotate-0 transition-transform duration-500 shadow-xl">
                        <div class="bg-white rounded-lg overflow-hidden shadow-inner border border-gray-100 aspect-[4/3] flex items-center justify-center bg-[url('https://cdn.dribbble.com/users/129972/screenshots/3964640/attachments/906660/cv-cover.png')] bg-cover bg-center">
