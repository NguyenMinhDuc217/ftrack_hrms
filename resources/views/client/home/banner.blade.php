...
<div class="container px-0 relative w-full bg-background">
    <!-- Blue Banner -->
    <div class=" h-[40px] sm:h-[400px] relative overflow-hidden flex items-center justify-center">
    ...
    <div class="container mx-auto px-4 -mt-8 md:-mt-12 relative z-20">
        <div class="bg-white rounded-lg shadow-xl p-3 md:p-6  border border-gray-100">
            ...
            <div class="flex flex-col md:flex-row items-start gap-3">
                ...
                <div class="w-full md:w-1/4 relative group flex flex-col gap-2">
                    <div class="flex items-center relative group">
                        <select id="listProvince" class="select2-single form-control block w-full pl-3 pr-10 py-3 !border !border-gray-200 rounded-lg leading-5 bg-gray-50 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 sm:text-sm appearance-none transition-colors text-gray-700">
                ...
                <div class="w-full md:w-auto flex gap-3 h-[53.6px]">
                    ...
                    <a href="{{ route('client.home') }}" class="w-1/3 py-3 px-4 flex justify-center items-center border border-transparent text-sm font-medium rounded-lg bg-light hover:bg-gray-100  hover:text-primary hover:shadow-xl transition-all duration-200"><i class="ti ti-eraser text-xl"></i></a>
                </div>
            </div>
