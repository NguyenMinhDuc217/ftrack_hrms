...
<div class="relative w-full">
    ...
    <div class="container mx-auto px-4 -mt-8 md:-mt-12 relative z-20">
        <div class="bg-white rounded-2xl shadow-xl p-3 md:p-6 flex flex-col md:flex-row items-start gap-3 border border-gray-100">
            ...
            <div class="w-full md:w-1/4 relative group flex flex-col gap-2">
                ...
                <div class="flex">
                    <a onclick="getCurrentLocation()" class="text-sm underline text-gray-400 cursor-pointer hover:text-primary transition-colors"><i class=" bi bi-geo-alt text-[var(--accent-color)] mr-2"></i>{{ __('default.txt_get_current_location') }}</a>
                </div>
            </div>
