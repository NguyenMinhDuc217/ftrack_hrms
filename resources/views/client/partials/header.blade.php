<header id="header" class="header d-flex align-items-center sticky-top py-2">
  <div class="page container-fluid container-xl position-relative d-flex align-items-center container mx-auto px-0">

    <a href="https://cpmvietnam.com/" class="logo d-flex align-items-center me-auto">
    ...
    <nav id="navmenu" class="navmenu">
      <ul class="max-h-max">
        ...
        @can('admin.dashboard')
        <li>
          <a class="p-2 px-4 rounded-lg bg-black text-white border-1 hover:!bg-white hover:!text-black hover:border-1 hover:border-black alumni-font " href="{{ route('admin.dashboard') }}">Admin</a>
        </li>
        @endcan
...
<style>
  ...
  .border-gradient-btn::before {
    ...
    position: absolute;
    inset: 0px;
    /* Điều chỉnh để glow lệch ra ngoài - tăng số để glow xa hơn (offset) */
    ...
    filter: blur(8px);
    /* Tạo glow phát sáng - chỉnh số để mạnh/yếu hơn */
    opacity: 0.8;
    /* Độ trong suốt glow - chỉnh tùy thích */
    z-index: -1;
  }
