...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <form action="{{ route('admin.orgs.update', $org) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @if (isset($org))
                @method('PATCH')
                @endif
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="editor-description">{{ $org->description }}</textarea>
                        @error('description')
                        <div class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </div>
