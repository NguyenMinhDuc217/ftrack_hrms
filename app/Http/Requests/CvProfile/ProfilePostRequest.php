...
class ProfilePostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'proj.*.description' => ['nullable', 'string', 'max:3000'],
        ];
    }
    ...
    {
        return [
            'skill.*.group'                    => 'Tên nhóm kỹ năng',
            'skill.*.old_group'                => 'Tên nhóm cũ',
            'skill.*'                          => 'Nhóm kỹ năng',
            'skill.*.skills.*.newSkillName'    => 'Tên kỹ năng',
            'skill.*.skills.*.newSkillExp'     => 'Số năm kinh nghiệm',
        ];
    }
}
