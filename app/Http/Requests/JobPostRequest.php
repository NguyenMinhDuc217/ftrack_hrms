...
class JobPostRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'profession_ids.required' => __('job.profession_id_required'),
            'profession_ids.max' => __('job.profession_id_max'),
            'profession_ids.exists' => __('job.profession_id_exists'),
            ...
            'tag_ids.required' => __('job.tag_ids_required'),
            'tag_ids.max' => __('job.tag_ids_max'),
            'tag_ids.array' => __('job.tag_ids_array'),
            ...
            'min_salary.required' => __('job.min_salary_required'),
            'min_salary.numeric' => __('job.min_salary_decimal'),
            'min_salary.lte' => __('job.min_salary_lte'),
            'max_salary.required' => __('job.max_salary_required'),
            'max_salary.numeric' => __('job.max_salary_decimal'),
            'max_salary.gte' => __('job.max_salary_gte'),
            'currency.required' => __('job.currency_required'),
